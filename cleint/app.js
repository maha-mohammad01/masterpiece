    ...
    try {
      ...
      if (req.files && req.files.length > 0) {
        req.files.forEach(file => {
          ...
          images_url.push(file.filename);
        });
      }
  
      // Add the request to the stadiums table with the approval status set to 'pending'
      const result = await pool.query(
        ...
        [name, city, location, size, hourly_rate, description, user_id, 'pending', images_url, phone, start_time, end_time]
      );
...
app.post('/book-stadium/:stadium_id', authenticateToken, async (req, res) => {
  console.log("",req.body)
